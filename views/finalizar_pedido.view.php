...
<div id="container">
    ...
    <form action="finalizar_pedido.php?acao=cadastrar" method="POST" id="finalPedido">
        <span class="title">Confira seu pedido</span>
        <div class="column info">
            <hr>
            <?php $total = 0;
            foreach ($carrinho_usuario['itens'] as $car) : $total += $car['total']; ?>
                ...
                <div class="itens_pedido row">
                    <div class="co">
                        ...
                        <?php if ($car['borda']['preco'] > 0) : ?>
                            <span>+ R$<?= $car['borda']['preco'] ?> Borda <?= $car['borda']['borda'] ?></span>
                        <?php endif; ?>
                        <?php if ($car['massa']['preco'] > 0) : ?>
                            <span>+ R$<?= $car['massa']['preco'] ?> Massa <?= $car['massa']['massa'] ?></span>
                        <?php endif; ?>
